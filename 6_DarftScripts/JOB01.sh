...
#SBATCH --output=/lustre/home/sww208/QC/SNParrayQC/5_JobReports/job.o
#SBATCH --error=/lustre/home/sww208/QC/SNParrayQC/5_JobReports/job.e
...
Ref1000G="/lustre/home/sww208/QC/SNParrayQC/4_Resources/1000G/1000GfromKnight/1000G_LiftedOver_hg19_maffilt_updateID"
LiftChain="${RESOURCEDIR}/LiftOverTools/hg18ToHg19.over.chain.gz"
...
PCAforPlinkData merged_1000G_fromKnight merged_1000G_fromKnight 3

# plot PCs - take 11mins
echo "Plot the PCs---------------------------------------------------------------------------"
Rscript ${SCRIPTDIR}/4_Resources/plotEthnicity.r ${PROCESSDIR}/CheckEthnicity/1000GCompare ${RESULTSDIR}/PCAVariants/merged_1000G_fromKnight ${KGG} 