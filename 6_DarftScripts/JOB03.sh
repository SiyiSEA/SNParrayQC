...
#SBATCH --output=/lustre/home/sww208/QC/SNParrayQC/5_JobReports/job03liftOverhg38.o
#SBATCH --error=/lustre/home/sww208/QC/SNParrayQC/5_JobReports/job03liftOverhg38.e
...
Ref1000G="/lustre/home/sww208/QC/SNParrayQC/4_Resources/1000G/1000GfromLiftOverhg38/hg19_1000G_from_hg38_updatename"
...
PCAforPlinkData merged_1000G_fromGH38 merged_1000G_fromGH38 3

# plot PCs - take 11mins
echo "Plot the PCs---------------------------------------------------------------------------"
Rscript ${SCRIPTDIR}/4_Resources/plotEthnicity.r ${PROCESSDIR}/CheckEthnicity/1000GCompare ${RESULTSDIR}/PCAVariants/merged_1000G_fromGH38 ${KGG} 